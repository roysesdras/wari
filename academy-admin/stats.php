...
<aside class="w-56 bg-slate-950 border-r border-slate-800 min-h-screen fixed left-0 top-0 bottom-0 flex flex-col z-50">
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5">
        ...
        <a href="/academy-admin/stats.php" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-emerald-500 bg-emerald-500/10 font-semibold text-[13px]">Statistiques</a>
...
<div class="ml-56 flex-1 flex flex-col min-h-screen">
    ...
    <div class="p-8 flex-1">
        ...
        <div class="grid grid-cols-12 gap-4 mb-4">
            ...
            <div class="col-span-3 card-green-top bg-slate-950 border border-slate-800 rounded-2xl p-5 anim overflow-hidden">
                <div class="absolute top-4 right-4 text-emerald-900/50">
                ...
                <p class="font-black text-emerald-500 text-5xl leading-none"><?= number_format($stats['total_apprenants']) ?></p>
                <p class="text-slate-600 text-[11px] mt-2">utilisateurs actifs sur Academy</p>
            </div>

            <div class="col-span-3 card-green-top bg-slate-950 border border-slate-800 rounded-2xl p-5 anim overflow-hidden" style="animation-delay:.06s">
                <div class="absolute top-4 right-4 text-emerald-900/50">
                ...
                <p class="font-black text-emerald-500 text-5xl leading-none"><?= number_format($stats['total_completions']) ?></p>
                <p class="text-slate-600 text-[11px] mt-2">leçons complétées au total</p>
            </div>

            <div class="col-span-3 card-green-top bg-slate-950 border border-slate-800 rounded-2xl p-5 anim overflow-hidden" style="animation-delay:.12s">
                <div class="absolute top-4 right-4 text-emerald-900/50">
                ...
                <p class="font-black text-emerald-500 text-5xl leading-none"><?= $stats['total_cours'] ?></p>
                <p class="text-slate-600 text-[11px] mt-2">cours publiés</p>
            </div>

            <div class="col-span-3 card-green-top bg-gradient-to-br from-slate-800 to-ink-900 border border-slate-800 rounded-2xl p-5 anim overflow-hidden" style="animation-delay:.18s">
                <div class="absolute top-4 right-4 text-emerald-800/50">
                ...
                <p class="text-[10px] font-bold tracking-[.12em] uppercase text-emerald-800 mb-2">Revenus PDF</p>
                <p class="font-black text-emerald-400 leading-none" style="font-size:2.4rem">
                    <?= number_format($stats['total_revenus'], 0, ',', ' ') ?>
                </p>
                <p class="text-emerald-900 text-[11px] mt-2 font-semibold">FCFA générés</p>
            </div>
        ...
        <div class="grid grid-cols-12 gap-4 mb-4">
            ...
            <!-- Top cours -->
            <div class="col-span-7 card-green-top bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden anim">
                <div class="px-6 py-4 border-b border-slate-800 flex items-center justify-between">
                    <p class="font-bold text-slate-100 text-sm flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-emerald-700"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2z"/></svg>
                        ...
                        <div class="flex items-center justify-between mb-1">
                            <div class="flex items-center gap-2 min-w-0">
                                <span class="w-5 h-5 rounded-md flex items-center justify-center text-[10px] font-black shrink-0
                                    <?= $i === 0 ? 'bg-gold-900/50 text-emerald-500' : 'bg-white/5 text-slate-600' ?>">
                                    <?= $i + 1 ?>
                                </span>
                            ...
                            <div class="flex items-center gap-4 shrink-0 ml-3">
                                ...
                                <span class="font-bold text-emerald-500 text-sm"><?= number_format($cours['nb_apprenants']) ?></span>
                            </div>
                        </div>
                        <div class="hbar">
            ...
            <!-- Stats par catégorie -->
            <div class="col-span-5 card-green-top bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden anim" style="animation-delay:.08s">
                <div class="px-6 py-4 border-b border-gold-900/70">
                    <p class="font-bold text-slate-100 text-sm flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-emerald-700"><rect width="7" height="7" x="3" y="3" rx="1"/><rect width="7" height="7" x="14" y="3" rx="1"/><rect width="7" height="7" x="14" y="14" rx="1"/><rect width="7" height="7" x="3" y="14" rx="1"/></svg>
                        Par thématique
                    </p>
                </div>
                <div class="divide-y divide-slate-800">
                    ...
                    <div class="px-6 py-3.5">
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            <span class="font-bold text-emerald-500 text-sm"><?= number_format($cat['nb_apprenants']) ?></span>
                        </div>
                        <div class="flex items-center gap-3">
        ...
        <div class="grid grid-cols-12 gap-4 mb-4">
            ...
            <div class="col-span-6 card-green-top bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden anim">
                <div class="px-6 py-4 border-b border-gold-900/70 flex items-center justify-between">
                    <p class="font-bold text-slate-100 text-sm flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-emerald-700"><circle cx="12" cy="12" r="10"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 18V6"/></svg>
            ...
            <!-- Campagnes email -->
            <div class="col-span-6 card-green-top bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden anim" style="animation-delay:.08s">
                <div class="px-6 py-4 border-b border-slate-800 flex items-center justify-between">
                    <p class="font-bold text-slate-100 text-sm flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-emerald-700"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                        Campagnes emails récentes
                    </p>
                    <a href="/academy-admin/emails.php" class="text-[11px] text-emerald-700 hover:text-emerald-500 font-semibold transition-colors">
                        Tout voir →
                    </a>
                </div>
                <div class="divide-y divide-slate-800">
                    <?php if (!empty($emailCampagnes)): ?>
                        ...
                        <div class="flex items-center gap-3 px-6 py-3 hover:bg-white/[.02] transition-colors">
                            <div class="w-7 h-7 rounded-lg bg-emerald-500/10 flex items-center justify-center shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-emerald-700"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                            </div>
                            ...
                            <div class="text-right shrink-0">
                                <p class="font-bold text-emerald-500 text-sm"><?= number_format($camp['nb_envoyes']) ?></p>
        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-6 card-green-top bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden anim">
                <div class="px-6 py-4 border-b border-slate-800">
                    <p class="font-bold text-slate-100 text-sm flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-emerald-700"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
                        Leçons les plus complétées
                    </p>
                </div>
                <div class="divide-y divide-slate-800">
                    <?php if (!empty($topLecons)): ?>
                        ...
                        <div class="flex items-center gap-3 px-6 py-3.5 hover:bg-white/[.02] transition-colors">
                            ...
                            <div class="text-right shrink-0">
                                <p class="font-bold text-emerald-500 text-sm"><?= number_format($lecon['nb_completes']) ?></p>
            ...
            <div class="col-span-6 card-green-top bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden anim" style="animation-delay:.08s">
                <div class="px-6 py-4 border-b border-slate-800">
                    <p class="font-bold text-slate-100 text-sm flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-emerald-700"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                ...
                <div class="divide-y divide-slate-800">
                    <?php if (!empty($topUsers)): ?>
                        ...
                        <div class="flex items-center gap-3 px-6 py-3.5 hover:bg-white/[.02] transition-colors">
                            ...
                            <div class="shrink-0">
                                <span class="text-[10px] bg-emerald-500/10 border border-slate-800 text-emerald-700 px-2.5 py-1 rounded-full font-semibold">
