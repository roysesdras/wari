...
<head>
    ...
    <style>
        ...
        .filter-select:focus { border-color: rgba(16,185,129,.4); }
...
<aside class="w-56 bg-slate-950 border-r border-slate-800 min-h-screen fixed left-0 top-0 bottom-0 flex flex-col z-50">
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5">
        ...
        <a href="/academy-admin/emails.php" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-emerald-500 bg-emerald-500/10 font-semibold text-[13px]">Emails</a>
...
<div class="ml-56 flex-1 flex flex-col min-h-screen">
    ...
    <div class="p-8 flex-1">
        ...
        <div class="grid grid-cols-12 gap-4 mb-6">
            ...
            <!-- Total envoyés -->
            <div class="col-span-3 card-green-top bg-slate-950 border border-slate-800 rounded-2xl p-5 anim">
                <div class="text-emerald-700 mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg></div>
                <p class="font-black text-emerald-500 text-4xl leading-none"><?= number_format($statsEmail['total_envoyes']) ?></p>
                <p class="text-slate-600 text-[11px] mt-1">emails envoyés</p>
            </div>

            <!-- Échecs -->
            <div class="col-span-2 card-green-top bg-slate-950 border border-slate-800 rounded-2xl p-5 anim" style="animation-delay:.05s">
                <div class="text-emerald-700 mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="m4.9 4.9 14.2 14.2"/></svg></div>
            ...
            <!-- Taux succès -->
            <div class="col-span-3 card-green-top bg-slate-950 border border-slate-800 rounded-2xl p-5 anim" style="animation-delay:.10s">
            ...
            <!-- Cette semaine -->
            <div class="col-span-2 card-green-top bg-slate-950 border border-slate-800 rounded-2xl p-5 anim" style="animation-delay:.15s">
                <div class="text-emerald-700 mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg></div>
                <p class="font-black text-emerald-500 text-4xl leading-none"><?= number_format($emailsSemaine) ?></p>
                <p class="text-slate-600 text-[11px] mt-1">cette semaine</p>
            </div>

            <!-- Cours couverts -->
            <div class="col-span-2 card-green-top bg-slate-950 border border-slate-800 rounded-2xl p-5 anim" style="animation-delay:.20s">
                <div class="text-emerald-700 mb-2"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/></svg></div>
                <p class="font-black text-emerald-500 text-4xl leading-none"><?= $statsEmail['total_cours'] ?></p>
        ...
        <!-- ════ CAMPAGNES PAR COURS ══════════════════════ -->
        <div class="card-green-top bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden mb-6 anim">
                ...
                <div class="grid grid-cols-12 gap-3 px-6 py-4 items-center hover:bg-white/[.025] transition-colors"
                    ...
                    <div class="col-span-4 flex items-center gap-2 min-w-0">
                        <a href="/academy-admin/emails.php?course_id=<?= $camp['course_id'] ?>"
                           class="font-semibold text-slate-200 text-[13px] truncate hover:text-emerald-400 transition-colors">
                            <?= $camp['cat_icone'] ?> <?= htmlspecialchars($camp['course_titre']) ?>
                        </a>
                    </div>

                    <div class="col-span-2 text-center">
                        <span class="font-bold text-emerald-500 text-sm"><?= number_format($camp['nb_envoyes']) ?></span>
                    </div>
        ...
        <div class="card-green-top bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden anim">
            ...
            <div class="px-6 py-4 border-b border-slate-800 flex items-center justify-between flex-wrap gap-3">
                <div>
                    <p class="font-bold text-slate-100 text-sm flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-emerald-700"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M12 7v5l4 2"/></svg>
                        Logs détaillés
                    </p>
            ...
            <div class="px-6 py-4 border-t border-slate-800 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="?page=<?= $filterPage - 1 ?><?= $filterCourse ? '&course_id='.$filterCourse : '' ?><?= $filterStatut ? '&statut='.$filterStatut : '' ?>"
                       class="text-[11px] bg-white/5 hover:bg-emerald-500/10 border border-white/5 hover:border-slate-800 text-slate-400 hover:text-emerald-500 px-3 py-1.5 rounded-lg transition-all">
                        ← Précédente
                    </a>
                    <?php endif; ?>
                    ...
                    <a href="?page=<?= $p ?><?= $filterCourse ? '&course_id='.$filterCourse : '' ?><?= $filterStatut ? '&statut='.$filterStatut : '' ?>"
                       class="text-[11px] px-3 py-1.5 rounded-lg transition-all
                           <?= $p === $filterPage
                               ...
                               : 'bg-white/5 hover:bg-emerald-500/10 border border-white/5 text-slate-400 hover:text-emerald-500' ?>">
                        <?= $p ?>
                    </a>
                    <?php endfor; ?>
