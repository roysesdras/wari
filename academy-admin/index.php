...
$derniersCours = $pdo->query("
    SELECT co.titre, co.id, co.est_actif, c.titre as cat_titre
...
<head>
    ...
    <style>
        ...
        .bg-pattern {
            background-image:
                repeating-linear-gradient(45deg,
                    ...
                    rgba(16, 185, 129, .015) 40px,
                    rgba(16, 185, 129, .015) 41px);
        }
        ...
        /* Glow doré */
        .green-glow {
            box-shadow: 0 0 30px rgba(16, 185, 129, .06);
        }
...
════════════════════════════════════════════════════════ -->
    <aside class="w-56 bg-slate-950 border-r border-slate-800 min-h-screen fixed left-0 top-0 bottom-0 flex flex-col z-50">
        ...
        <div class="px-5 py-6 border-b border-slate-800">
            <span class="block font-black text-emerald-500 text-lg tracking-wide leading-none">
                Wari Academy
            </span>
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5">
            ...
            <a href="/academy-admin/index.php"
                class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-emerald-500 bg-emerald-500/10 font-semibold text-[13px]">
                Dashboard
            </a>
        ...
        <div class="px-3 py-4 border-t border-slate-800">
            <div class="flex items-center gap-3 px-2 py-2 mb-1">
                <div>
                    <p class="text-[13px] font-semibold text-emerald-400 leading-none">
...
════════════════════════════════════════════════════════ -->
    <div class="ml-56 flex-1 flex flex-col min-h-screen">
        ...
        <div class="bg-slate-950/80 backdrop-blur border-b border-slate-800 px-8 h-14 flex items-center justify-between sticky top-0 z-40">
            <div class="flex items-center gap-3">
                ...
                <span class="text-slate-500 text-xs"><span class="text-emerald-400 text-xs font-bold uppercase tracking-wider">
                        <?php
            ...
            <div class="flex items-center gap-3">
                <span class="text-[11px] text-emerald-700 bg-emerald-500/10 border border-slate-800 px-3 py-1 rounded-full font-medium flex items-center gap-1.5">
        ...
        <div class="p-8 flex-1">
            ...
            <div class="grid grid-cols-12 gap-4 mb-4">
                ...
                <div class="col-span-3 relative bg-slate-950 border border-slate-800 rounded-2xl p-6 green-glow card-green-top animate-fade-up overflow-hidden">
  ...
  <path d="M12 12a5.25 5.25 0 1 0 0-10.499A5.25 5.25 0 0 0 12 12Zm0 1.5c-3.254 0-9.75 2.01-9.75 6v3h19.5v-3c0-3.99-6.496-6-9.75-6Z"></path>
                    ...
                    <p class="font-black text-emerald-500 text-5xl leading-none mb-2">
                        <?= number_format($stats['total_apprenants']) ?>
                    </p>
                    <p class="text-slate-500 text-[12px]">utilisateurs actifs sur Academy</p>
                    <div class="mt-4 h-px bg-gradient-to-r from-emerald-500/20 to-transparent"></div>
                ...
                <!-- ── Carte Completions -->
                <div class="col-span-3 relative bg-slate-950 border border-slate-800 rounded-2xl p-6 card-green-top animate-fade-up-d1 overflow-hidden">
                    <div class="absolute top-4 right-5 text-3xl opacity-75">
                        <svg width="46" height="46" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- ── Carte Cours actifs -->
                <div class="col-span-3 relative bg-slate-950 border border-slate-800 rounded-2xl p-6 card-green-top animate-fade-up-d2 overflow-hidden">
                    <div class="absolute top-4 right-5 text-3xl opacity-75">
                        <svg width="46" height="46" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- ── Carte Revenus PDF -->
                <div class="col-span-3 relative bg-gradient-to-br from-slate-800 to-ink-900 border border-slate-800 rounded-2xl p-6 card-green-top animate-fade-up-d3 overflow-hidden">
                    <div class="absolute top-4 right-5 text-3xl opacity-75  ">
                        <svg width="46" height="46" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 9h19a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V9Zm1-6h15v4H2V4a1 1 0 0 1 1-1Zm12 11v2h3v-2h-3Z"></path>
                        </svg>
                    </div>
                    <p class="text-[10px] font-bold tracking-[.14em] uppercase text-emerald-800 mb-3">
                        Revenus PDF
                    </p>
                    <p class="font-black text-emerald-400 leading-none mb-2" style="font-size:2.4rem">
                        <?= number_format($stats['total_revenus'], 0, ',', ' ') ?>
                    </p>
                    <p class="text-emerald-800 text-[12px] font-semibold">FCFA générés</p>
                    <div class="mt-4 h-px bg-gradient-to-r from-slate-800 to-transparent"></div>
                    <p class="text-[11px] text-emerald-900 mt-3">
            ...
            <div class="grid grid-cols-12 gap-4 mb-4">
                ...
                <!-- ── Dernier email (large) -->
                <div class="col-span-8 relative bg-slate-950 border border-slate-800 rounded-2xl p-6 overflow-hidden animate-fade-up">
                    ...
                    <?php if ($dernierEmail): ?>
                        <div class="flex items-center gap-6">
                            <div class="w-14 h-14 rounded-xl bg-emerald-500/20 border border-slate-700 flex items-center justify-center text-2xl shrink-0">
                                <svg width="46" height="46" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center gap-4 mt-3">
                                    <span class="text-[11px] bg-emerald-500/10 border border-slate-800 text-emerald-600 px-3 py-1 rounded-full font-medium">
                            ...
                            <div class="text-right shrink-0">
                                <p class="font-black text-emerald-500 text-4xl leading-none">
                ...
                <div class="col-span-4 bg-slate-950 border border-slate-800 rounded-2xl p-5 animate-fade-up-d1">
                    <p class="text-[10px] font-bold tracking-[.14em] uppercase text-slate-500 mb-4">
                        Actions rapides
                    </p>
                    <div class="grid grid-cols-2 gap-2">
                        <a href="/academy-admin/courses.php?action=add"
                            class="flex flex-col items-center gap-2 bg-white/5 hover:bg-emerald-500/10 border border-white/5 hover:border-slate-800 rounded-xl p-3 text-center transition-all group">
                            ...
                            <span class="text-[11px] font-semibold text-slate-400 group-hover:text-emerald-500 leading-tight">Ajouter cours</span>
                        </a>
                        <a href="/academy-admin/lessons.php?action=add"
                            ...
                            <span class="text-[11px] font-semibold text-slate-400 group-hover:text-emerald-500 leading-tight">Ajouter leçon</span>
                        </a>
  ...
  <path fill-rule="evenodd" d="M1.6 2.4A2.4 2.4 0 0 1 4 0h13.131L22.4 5.269V21.6A2.4 2.4 0 0 1 20 24H4a2.4 2.4 0 0 1-2.4-2.4V2.4Zm4 7.2H3.2v8h1.6v-3.2h.8a2.4 2.4 0 1 0 0-4.8Zm6.4 0H9.6v8H12a2.4 2.4 0 0 0 2.4-2.4V12A2.4 2.4 0 0 0 12 9.6Zm4 8v-8h4.8v1.6h-3.2v1.6h1.6v1.6h-1.6v3.2H16Z" clip-rule="evenodd"></path>
                            ...
                            <span class="text-[11px] font-semibold text-slate-400 group-hover:text-emerald-500 leading-tight">Ajouter PDF</span>
                        </a>
                        <a href="/academy-admin/stats.php"
                            class="flex flex-col items-center gap-2 bg-white/5 hover:bg-emerald-500/10 border border-white/5 hover:border-slate-800 rounded-xl p-3 text-center transition-all group">
                            <span class="text-xl group-hover:scale-110 transition-transform">
                            ...
                            <span class="text-[11px] font-semibold text-slate-400 group-hover:text-emerald-500 leading-tight">Statistiques</span>
                        </a>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <!-- ── Top cours -->
                <div class="col-span-4 bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden animate-fade-up">
                    ...
                    <div class="divide-y divide-slate-800">
                        <?php if (!empty($topCours)): ?>
                            <?php foreach ($topCours as $i => $cours): ?>
                                ...
                                <?= $i === 0 ? 'bg-emerald-500/20 text-emerald-500' : 'bg-white/5 text-slate-500' ?>">
                                        <?= $i + 1 ?>
                                    </div>
                                    <div class="flex-1 min-w-0">
                                    ...
                                    <div class="text-right shrink-0">
                                        <p class="font-bold text-emerald-500 text-base leading-none">
                ...
                <div class="col-span-4 bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden animate-fade-up-d1">
                    <div class="px-6 py-4 border-b border-slate-800 flex items-center justify-between">
                        <p class="font-bold text-slate-100 text-sm">Derniers ajouts</p>
                        <a href="/academy-admin/courses.php"
                            class="text-[11px] text-emerald-700 hover:text-emerald-500 font-semibold transition-colors">
                            Gérer →
                        </a>
                    ...
                    <div class="divide-y divide-slate-800">
                        <?php if (!empty($derniersCours)): ?>
                            <?php foreach ($derniersCours as $cours): ?>
                                <div class="flex items-center justify-between px-6 py-3.5 hover:bg-white/[.03] transition-colors">
                                    <div class="flex-1 min-w-0">
                                        <p class="text-[13px] font-semibold text-slate-200 truncate">
                                            <?= htmlspecialchars($cours['titre']) ?>
                                        </p>
                                        <p class="text-[10px] text-slate-500 truncate mt-0.5">
                                            <?= htmlspecialchars($cours['cat_titre']) ?>
                                        </p>
                                    </div>
                                    <div class="shrink-0 flex items-center gap-2">
                                        <?php if ($cours['est_actif']): ?>
                                            <span class="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]"></span>
                                        <?php else: ?>
                                            <span class="w-2 h-2 rounded-full bg-slate-600"></span>
                                        <?php endif; ?>
                                        <a href="/academy-admin/courses.php?action=edit&id=<?= $cours['id'] ?>" class="text-[11px] text-slate-400 hover:text-slate-200">
                                            Modifier
                                        </a>
                                    </div>
                                </div>
                ...
                <!-- ── Achats PDF récents -->
                <div class="col-span-4 bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden animate-fade-up-d2">
                    <div class="px-6 py-4 border-b border-slate-800 flex items-center justify-between">
                        ...
                        <?php if (!empty($achatsRecents)): ?>
                            <?php foreach ($achatsRecents as $achat): ?>
                                <div class="flex items-center gap-3 px-6 py-3.5 hover:bg-white/[.03] transition-colors">
                                    ...
                                    <div class="text-right shrink-0">
                                        <p class="text-[12px] font-bold text-emerald-500">
                                            <?= number_format($achat['montant'], 0, ',', ' ') ?>
                                            <span class="text-[9px] text-emerald-800">FCFA</span>
                                        </p>
