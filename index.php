...
<head>
    ...
    <link rel="stylesheet" href="./assets/styles.css?v=171">
...
<body class="p-3 pb-20">
    ...
    <div class="max-w-md mx-auto">
        ...
        <nav class="fixed bottom-0 left-0 right-0 z-[120] bg-[#0B141A]/95 backdrop-blur-lg shadow-[0_-10px_30px_rgba(0,0,0,0.6)] py-0 px-4 pb-safe">
            <div class="max-w-md mx-auto flex items-center justify-between relative">
                ...
                <!-- 2. Mettre à jour (Répartir) -->
                <div class="flex-1 flex justify-center">
                    <button onclick="saveBudget()" title="Répartir le montant"
                        ...
                        <span class="text-[8px] font-bold uppercase tracking-widest mt-0.5">Répartir</span>
                    </button>
                </div>
    ...
    <script src="./assets/main.js?v=171"></script>
    <script>
        // Logique Onboarding
        document.addEventListener('DOMContentLoaded', () => {
